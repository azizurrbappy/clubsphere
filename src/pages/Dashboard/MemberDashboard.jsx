...
const MemberDashboard = () => {
  ...
  const topPicks = [
    ...
    },
    {
      ...
      time: '6:00 PM SST',
      image:
        'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&q=80&w=2832',
      ...
      <div>
        ...
        <div className="flex flex-col items-center justify-center p-12 bg-gray-50 rounded-xl text-center border-2 border-dashed border-gray-200">
          ...
          <h3 className="font-bold text-lg mb-2">
            Your groups are quiet for now
          </h3>
          <p className="text-gray-500 text-sm max-w-md">
            Explore fresh events and stay connected with what's happening around
            you.
          </p>
        </div>
      </div>
