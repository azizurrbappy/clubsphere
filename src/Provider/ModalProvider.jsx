    ...
    <AuthModal value={modalContextValue}>
      ...
      {isAuthModalOpen && (
        <dialog open className="modal backdrop-blur-xs">
          <div className="modal-box w-11/12 max-w-[500px] p-0 rounded-3xl">
            ...
            <section className="px-7 pb-7">
              ...
              {!loginModal && (
                <div>
                  <button className="btn w-full bg-transparent hover:bg-gray-50 text-black border-0 shadow-none py-6 px-6 rounded-full text-lg font-semibold">
                    Sign up with email
                  </button>
              ...
              {/* login form */}
              {loginModal && <Login setLoginModal={setLoginModal}></Login>}
            </section>
          </div>
        </dialog>
      )}
